  ...
  artboards : [
    {
      ...
      canvas: {
        ...
        svg_data: [
          ...
          '<g transform="translate(50,150) scale(1.00,1.00)" class="accent"><circle cx="0" cy="0" r="15"></circle><circle cx="10" cy="10" r="10"></circle></g>'],
        color_scheme: {
          mainColor: '#cccccc',
          subColor: '#000000',
          accentColor: '#F0F0F0',
    ...
    },
    {
      ...
      canvas: {
        ...
        '<g transform="translate(50,150) scale(1.00,1.00)" class="accent"><circle cx="10" cy="10" r="15"></circle><circle cx="20" cy="20" r="10"></circle></g>'],
        color_scheme: {
          mainColor: '#cccccc',
          subColor: '#000000',
          accentColor: '#FAFAFA',
